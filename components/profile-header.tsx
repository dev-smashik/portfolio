        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-center justify-between gap-8">
            <div className="flex flex-col items-center gap-6 md:gap-8 text-center">
              <div className="relative w-60 h-60 md:w-60 md:h-60 rounded-full overflow-hidden border-1 border-black dark:border-white shadow-lg">
                <Image
                  src="/about-smashik.jpg?height=400&width=400"
